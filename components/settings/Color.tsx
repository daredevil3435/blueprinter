...
const Color = ({
    ...
    <div className = "flex flex-col gap-3 border-b border-primary-grey-200 p-5">
      <h3 className = "text=[10px] uppercase">
        ...
        <div className= "flex items-center gap-2 border-primary-grey-200"
        ...
        >
          ...
          <Label className = 'flex h-6 w-8 items-center justify-center bg-primary-grey-100 text-[10px]leading-3'>90%</Label>
        </div>
    </div>
